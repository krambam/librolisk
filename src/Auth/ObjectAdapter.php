...
class ObjectAdapter implements Zend_Auth_Adapter_Interface
{
    ...
    public function __construct(
        $identityClassname = null,
        $identityColumn = null,
        $credentialColumn = null,
        $objectPath = null
    ) {
        Zend_Db_Table::setDefaultAdapter(Pimcore_Resource::get()->getResource());
    ...
    {
        $conditions = array();
        $conditions[] = Zend_Db_Table::getDefaultAdapter()->quoteInto($this->_identityColumn . ' = ?',
            $this->_identityValue);
